...
- Name: portal-wizard.spec.ts >> Portal Wizard - Phase 2 Fixes >> should display valid logo URL preview
- Location: tests/portal-wizard.spec.ts:41:7
...
Call log:
  ...
  - waiting for locator('img.max-h-16')
  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e18]:
      ...
      - generic [ref=e26]:
        ...
        - button "2 Branding" [disabled] [ref=e33]:
          - generic [ref=e34]: "2"
          - generic [ref=e35]: Branding
        - button "3 Fields" [disabled] [ref=e37]:
          - generic [ref=e38]: "3"
          - generic [ref=e39]: Fields
        - button "4 Admin" [disabled] [ref=e41]:
          - generic [ref=e42]: "4"
          - generic [ref=e43]: Admin
        - button "5 Review" [disabled] [ref=e45]:
          - generic [ref=e46]: "5"
          - generic [ref=e47]: Review
      - generic [ref=e49]:
        - generic [ref=e50]:
          - heading "Branding" [level=2] [ref=e51]
          - paragraph [ref=e52]: Add your portal's branding elements.
        - generic [ref=e53]:
          - generic [ref=e54]: Logo URL (Optional)
          - textbox "https://example.com/logo.png" [active] [ref=e55]: https://via.placeholder.com/150
          - paragraph [ref=e56]: Enter the URL of your logo image. Leave empty to add later.
        - generic [ref=e57]:
          - paragraph [ref=e58]: "Preview:"
          - generic [ref=e60]: Invalid image URL
        - generic [ref=e61]:
          - button "← Back" [ref=e62]
          - 'button "Next: Fields" [ref=e63]'
...
```ts
  ...
  2   | 
  3   | /**
  4   |  * Test Suite: Portal Creation Wizard Fixes (Phase 2)
  5   |  *
  6   |  * Tests for issues #1, #2, #3, and #5
  7   |  */
  8   | 
  9   | const BASE_URL = 'http://localhost:3000';
  10  | const API_URL = 'http://localhost:3002';
  11  | 
  12  | test.describe('Portal Wizard - Phase 2 Fixes', () => {
  13  | 
  14  |   // Test Case 1: Logo Preview Error Handling
  15  |   test('should show error message for invalid logo URL', async ({ page }) => {
  16  |     // Login as superadmin
  17  |     await page.goto(`${BASE_URL}/admin/login`);
  18  |     await page.getByPlaceholder('superadmin@example.com').fill('superadmin@saasportal.com');
  19  |     await page.getByPlaceholder('••••••••').fill('SuperAdmin@2026');
  20  |     await page.getByRole('button', { name: 'Sign In' }).click();
  21  |     await page.waitForURL(`${BASE_URL}/admin`);
  22  | 
  23  |     // Navigate to create new portal
  24  |     await page.goto(`${BASE_URL}/admin/portals/new`);
  25  | 
